...
TTT1(){
super("Tic Tac Toe DiegoMonroy");

CheckboxGroup cbg=new CheckboxGroup();
c1=new Checkbox("VS Maquina",cbg,false);
c2=new Checkbox("Vs Amigo",cbg,false);
...
ic1=new ImageIcon("src/ic1.jpg");
ic2=new ImageIcon("src/ic2.jpg");
ic11=new ImageIcon("src/ic11.jpg");
ic22=new ImageIcon("src/ic22.jpg");
...
for(i=0;i<=7;i++){
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!Ganaste!!! Click En Reiniciar");			 break;
                   }
             else if(icon1==ic2){ 
             b[(a[i][1]-1)].setIcon(ic22);
             b[(a[i][2]-1)].setIcon(ic22);
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(TTT1.this,"!!!T_T (Usuario 2) Ha Ganado!!! Click En Reiniciar");
                break;			 
               }
         }
    }  
